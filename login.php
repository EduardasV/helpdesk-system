        ...
        <?php
          ...
          if (isset($_POST['username']) && isset($_POST['password']))
          {
            ...
            if ($u_type = \db\validate_user_credentials($username, $password, $user_id))
            {
              ...
              if (isset($_POST['language']) && in_array($_POST['language'], get_available_languages()))
              {
              ...
              $_SESSION["theme"] = \db\get_user_preference($user_id, 'theme');
              if ($_SESSION["theme"] === null) $_SESSION["theme"] = 'light';
